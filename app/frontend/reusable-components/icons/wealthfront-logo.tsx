...
type WealthfrontLogoProps = {
  width: number;
  height: number;
};

export const WealthfrontLogo: FC<Readonly<WealthfrontLogoProps>> = ({ height, width }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 150 140">
      {' '}
      <g fill="#4840BB">
